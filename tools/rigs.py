...
<svg class="rig-svg" viewBox="0 0 700 460" role="img"
  ...
  <!-- phase readout -->
  <g>
    <rect class="fr3" x="470" y="52" width="180" height="66" rx="4"/>
    <text class="lbl" x="486" y="76">PHASE</text>
    <text data-part="phase" class="lbl-ac" x="486" y="104" font-size="19">INSPECTION</text>
  </g>
</svg>
